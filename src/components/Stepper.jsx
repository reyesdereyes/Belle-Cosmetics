...
export default function BasicDemo() {
    ...
    const { cart, dispatch } = useCart(); // Obtener datos y funciones del contexto
    ...
    const calculateTotal = () => {
        ...
        return subtotal >= 100 ? subtotal : subtotal + 10; // Envío gratis si el subtotal es mayor o igual a $100
    };
    ...
    const handleQuantityChange = (nombre, change) => {
        ...
        if (updatedItem) {
            ...
            if (newQuantity > 0) {
                dispatch({
                    type: 'UPDATE_CART',
                    payload: { nombre, cantidad: newQuantity },
                });
            } else {
    ...
    // Función para vaciar el carrito con confirmación usando Toast
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link to="/carrito-vacio">
                            <Button
                                ...
                                icon="pi pi-trash" // Ícono de papelera
                                iconPos="left" // Coloca el ícono a la izquierda del texto
                                onClick={() => {
                                    dispatch({ type: 'CLEAR_CART' }); // Acción para vaciar el carrito
                                                        ...
                                                        <td>
                                                            <div className="d-flex align-items-center">
                                                                <button
                                                                    ...
                                                                    onClick={() =>
                                                                        handleQuantityChange(item.nombre, -1)
                                                                    }
                                                                >
                                                                    -
                                                                </button>
